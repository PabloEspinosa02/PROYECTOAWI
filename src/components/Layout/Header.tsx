...
const Header: React.FC<HeaderProps> = ({ setIsCartOpen, isProductsPage }) => {
  ...
  return (
    <header className={`fixed top-0 left-0 right-0 p-1 flex items-center ${isProductsPage ? 'bg-black' : 'bg-neutral-500'} text-white z-30`}>
      ...
      <div className="flex space-x-4 text-2xl">
        <a href="/login" className="transition ease-in-out duration-300 hover:text-gray-400 hover:transform hover:-translate-y-1 hover:scale-105">
